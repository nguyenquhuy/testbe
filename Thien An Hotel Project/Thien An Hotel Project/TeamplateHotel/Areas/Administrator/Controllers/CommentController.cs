    ...
    public class CommentController : BaseController
    {
        ...
        public JsonResult ListMenuByAjax(string languageId)
        {
            ...
            using (var db = new MyDbDataContext())
            {
                ...
                var listLanguageTemp = db.Menus.Where(a => a.LanguageID == languageId && a.Type == SystemMenuType.Gallery).Select(a => new Options() { DisplayText = a.Title, Value = a.ID.ToString(CultureInfo.InvariantCulture) }).ToList();
