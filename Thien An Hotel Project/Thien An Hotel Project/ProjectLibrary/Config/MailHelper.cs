...
namespace ProjectLibrary.Config
{
    ...
    {
        public static bool SendMail(string fromEmail, string toEmail, string subject, string content)
        {
            try
            {
                using (var db = new MyDbDataContext())
                {
                    ...
                    mail.ReplyToList.Add(new MailAddress(fromEmail, fromEmail, Encoding.UTF8));
